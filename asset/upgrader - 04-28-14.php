...
function get_queries(){
	...
	*/	
	...
	/* update district of Mt. Hagen Health Centre to Hagen */

	/*$query[0]['query'] = "UPDATE tbl_clinic SET llg_id = 18 WHERE ID = 28";
	$query[0]['log'] 	= "update district of Mt. Hagen Health Centre to Hagen";
	$query[0]['query'] = "UPDATE tbl_clinic SET llg_id = 18 WHERE ID = 20";
	$query[0]['log'] 	= "update district of pepka Outreach to Hagen";
		$query[0]['query'] = "UPDATE tbl_clinic SET llg_id = 18 WHERE ID = 14";
	$query[0]['log'] 	= "update district of pepka Outreach to Hagen";*/
