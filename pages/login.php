					...
					<div class="mainLeft">
						<div class="leftPane">
							...
							<?php if (preg_match('/testclients.susumamas.org.pg$/', $_SERVER['HTTP_HOST'])) { ?>
      							<div style="background:#EC7A7A;text-align:center ;width:30%;padding:5px;position:relative;right:0%;top:20px;z-index:10000;overflow:hidden"><h3>This is the TEST SITE (with auto deploy)</h3></div><?php
  							} ?>
						</div>
					</div>
					<div class="mainRight">
